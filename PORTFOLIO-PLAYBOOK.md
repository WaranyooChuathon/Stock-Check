...
กดเล่นได้ทันทีไม่มี login wall, ใช้ข้อมูลสมมติแทน [DB/API จริง], genericize ชื่อ/แบรนด์บริษัท
...
```
อ่าน component ที่ดึงข้อมูลทั้งหมด แล้วสร้าง mock layer ที่ generate ข้อมูลสมมติ realistic
...
seed ข้อมูลสมมติ — คง env-toggle (มี env=real / ไม่มี=mock) เพื่อพิสูจน์ backend โดยยัง company-safe
```
...
- **ข้อมูลสมมติล้วน** · genericize ชื่อบริษัท/ลูกค้า/พิกัด/อีเมล
