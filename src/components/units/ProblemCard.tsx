...
export function ProblemCard({ unit }: { unit: ProblemUnit }) {
  return (
    <Link
      href={`/units/${unit.id}`}
      className="flex h-full flex-col rounded-xl border border-red-200 bg-white p-4 transition-colors hover:bg-red-50/50 focus:outline-none focus:ring-2 focus:ring-blue-600/40 dark:border-red-900 dark:bg-gray-900 dark:hover:bg-red-950/30"
    >
      ...
      <div className="mt-auto flex flex-wrap items-center gap-x-3 gap-y-1 pt-2 text-xs text-gray-500 dark:text-gray-400">
